...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # YOUR CODE HERE
    train_x, train_y, test_x, test_y = get_MNIST_data()
    test_y, train_y=update_y(test_y, train_y)
    theta, cost_function_history = softmax_regression(train_x, train_y, temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
    plot_cost_function_over_time(cost_function_history)
...
def run_softmax_on_PCA(temp_parameter,n_components,pcs,train_pca,test_pca):
    train_x, train_y, test_x, test_y = get_MNIST_data()
...
#print('softmax test_error=', run_softmax_on_PCA(temp_parameter,n_components,pcs,train_pca,test_pca))
...
print('softmax test_error=', run_softmax_on_PCA(temp_parameter,n_components,pcs,train_cube,test_cube))
